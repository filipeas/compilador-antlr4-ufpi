...
class Jasmin:
    ...
    """
    funcao para pegar variavel da tabela de simbolos
    """
    ...
    """
    funcao que inicia a escrita do arquivo .j
    """
    ...
    """
    funcao que inicia a criacao do metodo principal
    """
    def criaMain(self):
        self.__write(
            """
    ...
    """
    funcao que fecha o metodo principal
    """
    def fechaMain(self):
        self.__write(
            """
    ...
    """
    funcao que cria um metodo
    """
    def criaFuncao(self, name, parameters):
        param = ''
        for p in parameters:
    ...
    """
    funcao que fecha a criacao de metodo
    """
    def fechaFuncao(self):
        self.__write(
            """
            return
            .end method
    ...
    """
    funcao que cria chamada de funcao dentro de metodo
    """
    def criaChamadaDeFuncao(self, func_name, params, types):
    ...
    """
    funcao que cria chamada de retorno dentro de um metodo
    """
    def criaFuncaoReturn(self, val, type):
    ...
    """
    funcao que cria chamada de funcao print
    """
    ...
    """
    funcao que calcula operador or
    """
    def calcOr(self, val1, val2, addr):
    ...
    """
    funcao que calcula operador and
    """
    def calcAnd(self, val1, val2, addr):
        self.load_temp(val1, 'bool')
        self.load_temp(val2, 'bool')
        self.__write(
            """
    ...
    """
    funcao que calcula expressoes logicas
    """
    def calcIgualdade(self, type, val1, val2, addr3, op):
    ...
    """
    funcao que cria divisao (inteira ou real)
    """
    ...
    """
    funcao que calcula funcao not
    """
    def calcNot(self, val, addr):
